      ...
      <div class="card p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <input type="date" v-model="formData.billDate" class="input w-full" required />
          </div>
        </div>
      </div>
        ...
        >
          ...
          <div class="grid grid-cols-2 md:grid-cols-6 gap-4">
            ...
            <div>
              ...
              <input v-model.number="item.tQty" type="number"
            ...
            <div>
              ...
              <input v-model.number="item.freeQty" type="number"
                class="input text-right"/>
            </div>
            ...
            <div>
              ...
              <select v-model.number="item.gst"
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <input :value="item.taxable.toFixed(2)"
                readonly class="input bg-gray-100 text-right"/>
            </div>

            <div>
              <label class="label">Amount</label>
              <input :value="item.amount.toFixed(2)"
                readonly class="input bg-gray-100 text-right font-semibold"/>
            </div>
